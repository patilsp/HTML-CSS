(() => {
	...
	const addMenuBackground = () => {
        ...
        if(pageWidth > mobileWidth) {
            boddyOffset > 0 ? navigation.classList.add("sp-nav-fixed") : navigation.classList.remove("sp-nav-fixed");
        }
	}

	const reorderResponsiveMenu = () => {
        const pageWidth = window.innerWidth;
        const navContainer = document.querySelector("header nav .sp-container");
        const navigation = document.querySelector("header nav .sp-navigation");
        const mobileNavigation = document.querySelector("body > .sp-navigation");
	...
	const mobileMenuToggle = () => {
        const menuToggle = document.querySelector(".sp-nav-toggle");

        menuToggle.addEventListener("click", () =>{
        	const mobileNavigation = document.querySelector("body > .sp-navigation");

        	mobileNavigation.classList.toggle("sp-navigation-opened");
        })
	}

	const onNavItemClick = () => {
		const navItemList = document.querySelectorAll(".sp-section-link");
	...
	const onTestimonialChange = () => {
        ...
        const prevArrow = document.querySelector("#sp-testimonials-prev");
        const nextArrow = document.querySelector("#sp-testimonials-next");
        const testimonials = document.querySelector(".sp-testimonials ul");
	...
	const onGalleryImageClick = () => {
        const galleryImageList = document.querySelectorAll("#sp-gallery li");
	...
	const galleryImageOpen = image => {
		...
		const openedImage = `<div class='sp-backdrop'><img src='${imageSrc}' alt='' />
		                    <span class="sp-backdrop-close">X</span></div>`;
	...
	const galleryImageClose = () => {
		const closeButton = document.querySelector(".sp-backdrop-close");
